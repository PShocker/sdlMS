...
private:
  static void clean_client(uint64_t client_id, ClientSceneT client_scene);
  ...
  static void send_in_fade(uint64_t client_id, ClientSceneT client_scene);
  static void init_scene(uint64_t client_id, ClientSceneT client_scene);

public:
  static void handle_scene(uint64_t client_id, ClientSceneT client_scene);
